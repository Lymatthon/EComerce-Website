...
<html>
    <head>
        ...
        <jsp:include page="/WEB-INF/pages/include/user/css-page-checkout.jsp" />
    </head>
    ...
    <body>
        ...
        <div class="super_container">
            ...
            <div class="super_container_inner">
                ...
                <!-- Cart -->                                           
                <jsp:include page="/WEB-INF/pages/include/user/checkout.jsp"/>
        ...
        <jsp:include page="/WEB-INF/pages/include/user/js-page-checkout.jsp"/>
    </body>
