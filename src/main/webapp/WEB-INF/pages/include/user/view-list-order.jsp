...
<div class="container">
    <c:forEach items="${orders}" var="order">
        <div class="row" style="background-color: #D6D6D6; margin-bottom: 20px; padding: 10px">
            <div >
                <span style="display: inline; color: black"><h3>Order ID: ${order.orderId} <h4 style="margin-left: 1020px; color: darkred; font-style: italic">${order.code} ${order.status}</h4></h3></span>
            </div>
